//
//  UnifiedPlaceInformationCell.swift
//  TrackingAdvisor
//
...
class UnifiedPlaceInformationCategory: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UnifiedPlaceInformationCellDelegate {
    
    var delegate: UnifiedPlaceInformationCategoryDelegate?
    ...
    func setupViews() {
        ...
        // register cell type
        infoCollectionView.register(UnifiedPlaceInformationCell.self, forCellWithReuseIdentifier: cellId)
...
protocol UnifiedPlaceInformationCellDelegate {
    func didReviewPersonalInformation(personalInformation: PersonalInformation?, type: ReviewType, rating: Int32)
}

class UnifiedPlaceInformationCell: UICollectionViewCell {
    var delegate: UnifiedPlaceInformationCellDelegate?
    ...
    lazy var privacyFeedbackRow: CommentRow = {
        let row = CommentRow(with: "You can give us some feedback on the explanation", icon: "chevron-right", backgroundColor: .clear, color: color) {
